...
function Header() {
    ...
    return (
        <>
            ...
            <div className="d-flex justify-content-center align-items-center make"
                 style={{marginTop: '200px', color: '#132650'}}>
            ...
            {/*<div style={{background: 'linear-gradient(to right, rgba(137, 196, 244, 0.9), rgba(29, 43, 100, 0.9))', height: '500px'}}>*/}
                <div style={{
                    display: 'flex',
                    alignItems: 'center',
                    marginTop: '40px',
                ...
                <div className="grid-container" style={{maxWidth: '1200px', margin: 'auto', padding: '0 10px'}}>
                    <div
                        style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', padding: '20px'}}>
                        
                        <h5 style={{alignSelf:'flex-end'}}>간단한 레벨테스트와<br/>내 맞춤 AI선생님이 항시 대기</h5>
                        ...
                        <Link to='/leveltest' style={{textDecoration: 'none', color: 'inherit'}}>
                            <div style={{
                                ...
                                <div style={{padding: '15px', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%'}}>
                                    <h5 style={{marginBottom: '10px'}}>레벨 테스트</h5>
                                    <img src={logo} alt="Speech"
                                         style={{width: '80px', height: '80px', objectFit: 'cover', margin: '0 auto'}}/>
                                    <p style={{marginTop: '10px', color: '#132650', fontSize: '14px'}}>당신의 레벨을 테스트 할 수
                                        있습니다!</p>
                                </div>
                            </div>
                        </Link>
